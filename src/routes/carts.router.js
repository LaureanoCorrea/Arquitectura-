...
cartsRouter.post("/add", passportCall(['jwt', 'github']), (req, res) => cartController.add(req, res));

cartsRouter.get("/cart", passportCall(['jwt', 'github']), (req, res) => cartController.getCart(req, res));

cartsRouter.put("/:pid", passportCall(['jwt', 'github']), (req, res) => cartController.update(req, res));
